...
Le code étant présent et commenté en annexes, nous ne reviendrons donc que brièvement sur les éléments clés :
  ...
  * nous nous sommes appuyé sur le package __R__ _glmnet_ \cite{glmnet} pour ajuster les régressions logistiques Lasso \cite{lasso} ;
...
Comme énoncé par Bühlmann et Meinshausen \cite{stabsel}, les résultats obtenus en terme de performance ou de taille du support sont proches pour des seuils de stabilité compris entre $0.6$ et $0.9$. Au delà $0.9$, les performances semblent se dégrader fortement en l'absence de variables visiblement importantes. \
...
La _Figure 4_ présentant les tables de contingence de la présence de certains motifs génomiques et de la résistance à l'antibiotique vient illustrer ces suppositions.
