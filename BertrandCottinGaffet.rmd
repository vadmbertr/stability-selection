...
\quad La capacité des modèles de stability selection à capter la résistance plutôt que la sensibilité et à rédiuire la taille du support en conservant les motifs les plus communs expliqueraient donc les bons résultats prédictifs donnés par celle-ci malgré des supports nettement plus compacts.
