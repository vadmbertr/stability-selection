...
Nous constatons que les coefficients significatifs obtenus par stability selection (quelque soit le seuil de stabilité) sont très majoritairement positifs tandis que les coefficients du Lasso classique sont positifs et négatifs tout en présentant une amplitude bien plus forte. 
...
La capacité des modèles de stability selection à capter la résistance plutôt que la sensibilité expliquerait donc les bons résultats données par celle-ci malgré des supports nettement plus compacts.
