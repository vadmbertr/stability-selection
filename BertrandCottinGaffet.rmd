...
\quad La capacité des modèles de stability selection à capter la résistance plutôt que la sensibilité expliquerait donc les bons résultats prédictifs donnés par celle-ci malgré des supports nettement plus compacts. 
...
que cette dernière méthode est plus efficiente que l'approche Lasso classique pour la prédiction de la résistance
...
être dû au fait que la procédure Lasso classique conserve de nombreux motifs génomiques sensibles en plus des motifs résistants.
Effectivement, les modèles de stability sélection se concentrent sur la prédiction de la résistance d'une souche bactérienne à un 
antibiotique alors que le modèle Lasso capte également la potentielle sensibilité des nouvelles souches.
